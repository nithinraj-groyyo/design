...
import { setWishlistItems, removeWishlistItem, removeFromLocalWishlist } from '../../redux/wishlistSlice';
...
const WishList = () => {
  ...
  }, [wishlistData, localWishlistData]);
  ...
  return (
    <BasicLayout showHeader={!isMobileView}>
      <section className="xxs:mt-0 lg:mt-[10rem]">
          ...
          {isWishlistEmpty ? (
            <div className="flex flex-col items-center justify-center min-h-[40vh]">
              <div className="bg-white shadow-md rounded-lg p-8 text-center max-w-md mx-auto">
                ...
                <Button
                  onClick={() => navigate('/')}
                  className="mt-4 bg-black text-white transition-all duration-300 px-4 py-2 lg:px-6 lg:py-3 rounded-lg shadow-md hover:shadow-lg focus:ring focus:ring-blue-300 focus:outline-none"
                >
                  Continue Shopping
                </Button>
              </div>
            ...
            <div className="grid grid-cols-2 p-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
