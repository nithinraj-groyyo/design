        ...
        <Formik
          ...
          onSubmit={async (values) => {
            try {
              ...
              formData.append('minQty', values.minQty.toString());
              formData.append('description', values.description);
              formData.append('isPublic', values.isPremium.toString());
              formData.append('isActive', values.isActive.toString());
              formData.append('categoryId', values.category.toString());
              formData.append('subCategoryId', values.subCategory.toString());
  
              if (catalogueId) {
                await updateCatalogue({ formData, catalogueId: Number(catalogueId), token }).unwrap();
